    ...
    <React.Fragment>
      <section className={`flex flex-col`}>
        <form
          ...
          className="flex flex-col font-Poppins px-10 py-5 "
        >
          <div className={`flex space-x-10`}>
            ...
            <div className={`w-1/2 flex flex-col gap-5`}>
              ...
              <div className={`space-y-2 flex flex-col`}>
                <label htmlFor="inistitution" className={`text-[15px]`}>
                  Inistitiute
                </label>
                <select
                  id="inistituion"
              ...
              <div className={`space-y-2`}>
                <label className={`font-Poppins mb-[0.5rem] text-[15px]`}>
                  Upload an Image
                </label>
                <input
                  type={`file`}
          ...
          <div className={`flex flex-col py-5`}>
            <label className={`inline-block font-Poppins mb-[0.5rem]`}>
              Address{" "}
            </label>
            <small className={`font-Quicksand text-sm text-[#6c757d]`}>
          ...
          <div className="flex justify-between items-center py-10">
            <button
              className={`btn-sm px-5 bg-[#0cd463] rounded-none text-white w-1/4 `}
            >
              Save
            </button>
          </div>

  ...
  return (
    <React.Fragment>
      <nav className="border-b-[1px] shadow-b-lg z-50">
        <div
          className={`flex justify-between items-center h-24 px-10 container mx-auto xxs:px-2 xs:px-10 ss:px-10 md:px-10 relative`}
        >
                  ...
                  <Link to={link.path}>
                    <button
                      className={`${
                        index === 0
                          ? "hidden"
                          : "flex items-center btn-sm bg-[#3C4852] text-white px-4 rounded-none"
                      }`}
                    >
              ...
              >
                ...
                {open && (
                  <motion.div
                    ...
                    className={
                      open
                        ? "fixed top-24 xxxs:w-[75%] xxs:w-[75%] xs:w-[60%] md:w-[50%] h-[80%] right-0 z-50 bg-white transition-opacity duration-10 "
                  ...
                  >
                    {link.map((link, index) => {
                      return (
                        <div
                          key={index}
                          className={`border-b border-gray-200 w-full py-5 px-5`}
                        >
                          <Link
                            to={link.path}

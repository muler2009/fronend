...
const AdminTopbar = () => {
  return (
    <React.Fragment>
        <section className={`bg-white p-0 mx-0 w-full h-24 border-b-1 border-[#ddd]`}>
            ...
            <div className={`flex justify-between items-center mx-4 py-3`}>
                ...
                <div className='flex items-center justify-center space-x-2'>                   
                    <h1 className={`font-Oswald text-blue-900 text-2xl tracking-wide`}>IeXitTutor.com</h1>
                </div>
            ...
            <div className='border-[1px] border-[#ddd] bg-white py-3'>
                <div className={`flex justify-between`}>
                    ...
                    <div className={`flex px-3 items-center space-x-2`} >
                        ...
                        <AiOutlineCaretRight />
                        <h6 className={`font-Poppins text-sm`}><span className='flex items-center gap-1'>
                    ...
                    <div className={`w-[40%] mr-10`}>
                        <input type='text' className={`input-sm font-Poppins`} placeholder="Search" />
                    </div>

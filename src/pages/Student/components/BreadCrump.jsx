  ...
  return (
    <Div className="w-full my-1 bg-zinc-50 py-3 px-5 flex xs:justify-end lg:justify-start">
        ...
        <div className="font-Poppins text-[#828692]">
            {
                locate.pathname === "/student" ? 'Dashboard /' :
                locate.pathname === "/student/profile" ?  "Profile /" : 
                locate.pathname === "/student/modules" ? "Module /" :
                locate.pathname === "/student/result" ? "Result" :
                locate.pathname === "/student/change_password" ? "Changing Password" : null 
            }
        </div>
    </Div>
  )

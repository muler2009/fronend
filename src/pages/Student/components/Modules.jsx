...
const AllModules = () => {
                    ...
                    <div className="flex space-x-2 justify-center cursor-pointer">
                        {
                          rowData === true 
                          ? (  
                              <button className={`btn-sm px-2 cursor-pointer rounded-lg text-white bg-green-500 disabled:bg-red-500 disabled:text-white`}>
                                  <Link to={`../new-exam`}>
  ...
  return (
   <React.Fragment>
    ...
    {
      isSuccess && (        
        <div className={`block bg-zinc-50 px-5 py-5 xxs:overflow-x-scroll md:overflow-x-scroll border-t-[1px] border-b-[1px]`}>
          <TableStructure 

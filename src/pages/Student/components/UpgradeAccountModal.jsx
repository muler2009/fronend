...
const UpgradeAccountModal = (props) => {
  ...
  return (
    <section className='bg-black bg-opacity-10 inset-0 fixed top-0  flex justify-center sm:px-10 z-50'>
        <div className={`container mx-auto h-auto bg-white relative top-10 rounded-t-lg sm:w-full sm:h-[700px] lg:w-[30%] lg:h-2/3`}>
          <div className={`border-b-1 flex flex-col`}>
            ...
            <div className={`${page === 0 ? "w-[50%] border-green-200 border-b-4" : 'w-[100%] border-green-200 border-b-4'}`} />

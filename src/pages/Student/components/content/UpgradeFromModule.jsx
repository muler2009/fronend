      ...
      >
        <div className={`flex flex-col space-y-2`}>
          ...
          <div className={`border-[1px] rounded-sm bg-[#fafafa] `}>
            <p className={`py-1 px-3`}>{dataSelected.moduleTotalQuestion}</p>
          </div>
        </div>
        ...
        <div className={`text-xl font-Poppins text-center mt-10`}>
          {dataSelected.moduleTotalQuestion === 200
            ? "200 ETB"
            : dataSelected.moduleTotalQuestion === 400
            ? "300 ETB"
            : dataSelected.moduleTotalQuestion === 500
            ? "350 ETB"
            : null}
        </div>
      </div>

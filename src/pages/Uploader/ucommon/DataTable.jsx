...
export const Table = (props) => {
    ...
    const { data, isSuccess, isFetching, isError, isLoading} = useGetModuleQuery()
                ...
                Cell: ({ row }) => {
                    ...
                    return(
                        <div className="hidden md:flex md:justify-evently space-x-2">
                            ...
                            <div className="w-6 h-6 flex justify-center items-center hover:rounded-full hover:bg-white hover:text-red-500 hover:scale-125" 
    ...
    }, useAction, useGlobalFilter, usePagination, )
        ...
        <React.Fragment>
            ...
            <div className={`flex flex-col my-5`}>
                ...
                <div className={`flex pb-5`}>
                    <div className={`w-1/4`} />                    
                    <div className={`w-3/4`}>
                       <h1 className={`font-Poppins text-sm text-[#6c757d] ml-[6%]`}>Type to search modules</h1>
                    </div>
                </div>

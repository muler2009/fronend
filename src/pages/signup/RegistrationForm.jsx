                    ...
                    <form className={`flex flex-col space-y-5`} onSubmit={(event) => event.preventDefault()}>
                            ...
                            <div className={`flex flex-col`}>
                                <div className={`flex space-x-5 items-center`}>
                                    <div className={`flex w-3/4`}>
                                        ...
                                        <select id='inistitute' type='text' name='inistitute' className={`select-md font-Poppins border border-l-0 rounded-l-none focus:border-[#ddd] bg-white w-full`}>
                            ...
                            <div className={`flex flex-col`}>
                                <div className={`flex space-x-5 items-center`}>
                                    <div className={`flex w-3/4`}>
                                        ...
                                        <select id='department' type='text' name='department' className={`select-md font-Poppins border border-l-0 rounded-l-none focus:border-[#ddd] bg-white w-full`}>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className={`flex flex-col`}>
                                <div className={`flex space-x-5 items-center`}>
                                    ...
                                    <div className={`w-1/4`}>
                                        <div className={`${boolValidators.passwordValidator ? "ml-2 text-green-700 text-xs" : "hidden"} flex items-center`}>
                                            <GiCheckMark color="green" size={25} /><span >Correct</span>
                                        </div>
                        ...
                        <div className="flex flex-col space-y-3 pt-5">
                            <div className='flex flex-row justify-start items-center space-x-2'>
                                <aside className={``}>
                                    <input type='checkbox' name="aggrement" id="aggrement" className="input-md" onChange={handleRegistrationChanges} />
                                </aside>
                        ...
                        <div className='py-4 relative top-6'>
                            <button className='w-1/2 px-2 py-5 bg-[#3C4852] text-sm rounded-none text-white font-Poppins cursor-pointer disabled:opacity-25 disabled:cursor-default' 
                                   onClick={() => {
                                        onCreateClicked()
                                        showSuccessAlert()
                                   }}
                                    disabled={!boolValidators.validLName || !boolValidators.validName || !boolValidators.validMatchPassword || !requiredValues.aggrement ? true : false}
                            >Create an account
                            </button>
                        </div>    
                    </form>
